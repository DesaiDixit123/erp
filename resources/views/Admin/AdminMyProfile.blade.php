                                            ...
                                            <div class="card-body">
                                                <form id="updateProfileForm" method="POST"
                                                    ...
                                                    <div class="d-flex align-items-center border-bottom pb-4 mb-4">
                                                        ...
                                                        <div class="ms-3">
                                                            <h6 id="profile-name">{{ $admin->name }}</h6>
                                            ...
                                            <div class="card-body">
                                                @if(session('admin'))
                                                    <form action="{{ route('admin.logout') }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <p><strong>Alert</strong>: Once you delete your admin session, you
                                                            will be logged out.</p>
                                                        <input type="submit" class="btn btn-danger mt-2"
                                                            value="Logout Admin Session">
                                                    </form>
                                                @elseif(session('employee_logged_in'))
                                                    <form action="{{ route('employee.delete', session('employee_id')) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
