                    ...
                    <div class="row g-4">
                        ...
                        <div class="d-flex justify-content-center min-vh-100 bg-light">
                            <div class="col-md-12">
                                        ...
                                        <form action="{{ route('casting.store') }}" method="POST">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" name="machine_operator_name1"
                                                        class="form-control" required>
                                                </div>
                                                <div class="col-md-4">
                                                    <label class="form-label">Machine Operator 2</label>
                                                    <input type="text" name="machine_operator_name2"
                                                        class="form-control" required>
                                                </div>
                                            </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-striped align-middle">
                                                <thead class="table-primary">
                                                    <tr>
                                                        <th class="" style="white-space: nowrap;">Sr No</th>
                                                        <th>Date</th>
                                                        <th>Shift</th>
                                ...
                                <div class="card shadow mt-4">
                                    <div class="card-body">
                                        <h5 class="mb-3 text-success">All Casting Process Records</h5>
                                        <div class="card shadow mt-4">
                                            <div class="card-body">
                                                <form method="GET" action="{{ route('casting.index') }}">
                                                    <div class="row g-3">
                                            ...
                                            <table class="table table-bordered table-striped align-middle">
                                                <thead class="table-success">
                                                    <tr>
                                                        ...
                                                        <th style="white-space: nowrap;">Machine Number</th>
                                                        <th style="white-space: nowrap;">Component Name</th>
                                                        <th style="white-space: nowrap;">Machine Operator Name</th>
                                                        <th style="white-space: nowrap;">Quantity (KG)</th>
                                                        <th style="white-space: nowrap;">Quantity (PCS)</th>
                                                        <th style="white-space: nowrap;">Updated Date</th>
                                                        <th>Action</th>
                                                ...
                                                <tbody>
                                                    @forelse($allRecords as $index => $record)
                                                        <tr>
                                                            ...
                                                            <td>{{ $record->machine_operator_name }}</td>
                                                            <td>{{ $record->quantity_kg }}</td>
                                                            <td>{{ $record->quantity_pcs }}</td>
                                                            <td style="white-space: nowrap;">
                                                                {{ $record->updated_at->timezone('Asia/Kolkata')->format('d M Y, h:i A') }}
