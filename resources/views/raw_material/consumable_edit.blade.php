                                ...
                                <div class="card-body py-4 px-4">
                                    <div
                                        ...
                                        <div class="mb-2 mb-md-0">
                                            <h4 class="mb-1 text-primary fw-semibold">Edit Consumables Raw Material</h4>
                        ...
                        <div class="d-flex justify-content-center min-vh-100 bg-light">
                            <div class="col-md-12">
                                <div class="card shadow">
                                    <div class="card-body">
                                        <form action="{{ route('consumable.update', $consumable->id) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <select class="form-select" id="raw_material_type_id"
                                                        ...
                                                        @foreach($types as $type)
                                                            <option value="{{ $type->id }}" {{ $consumable->raw_material_type_id == $type->id ? 'selected' : '' }}>
                                                                {{ $type->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="mb-3 col-md-6">
                                                    ...
                                                    <input type="number" class="form-control" id="quantity"
                                                        name="quantity"
                                                        value="{{ old('quantity', $consumable->quantity) }}" required
                                                        min="1">
                                                </div>
                                            </div>
                                            ...
                                            <!-- Submit Button -->
                                            <div class="d-grid">
                                                <button type="submit" class="btn btn-primary">Update Consumable
                                                    Material</button>
                                            </div>
                                        </form>
