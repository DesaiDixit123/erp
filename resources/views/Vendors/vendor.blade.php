                        ...
                        <div class="d-flex justify-content-center  min-vh-100 bg-light">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card shadow mt-4">
                                    <div class="card-body">
                                        <h5 class="mb-3 text-primary">All Vendors</h5>

                                        <!-- 🔎 Search Box -->
                                        <form method="GET" action="{{ route('vendor.index') }}" class="mb-3 d-flex">
                                            <input type="text" name="search" value="{{ request('search') }}"
                                                class="form-control me-2" placeholder="Search Vendor by Name">
