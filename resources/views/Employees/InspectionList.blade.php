                            ...
                            <div class="card ">
                                ...
                                <div class="card-body card-breadcrumb">
                                    ...
                                    <div class="page-title-box d-flex align-items-center justify-content-between">
                                        ...
                                        <h4 class="mb-0">Inspection List</h4>
                                        ...
                                        <tbody>
                                            @forelse ($inspections as $inspection)
                                                <tr>
                                                    ...
                                                    <td>{{ \Carbon\Carbon::parse($inspection->created_at)->timezone('Asia/Kolkata')->format('d M Y,h:i A') }}
                                                    </td>
                                                    <td>
                                                        <span
                                                            class="badge {{ $inspection->user_status === 'Active' ? 'bg-success' : 'bg-secondary' }}">
                                                            {{ ucfirst($inspection->user_status) }}
                                                        </span>
                                                    </td>
                                                    <td class="order-btn d-flex">
                                                        @if ($inspection->user_status == 'Active')
                                                            <form action="{{ route('employee.deactivate', $inspection->id) }}"
                                                        ...
                                                        @else
                                                            <form action="{{ route('employee.activate', $inspection->id) }}"
                                                                method="POST" class="me-2">
                                                                @csrf
                                                                <button type="submit"
                                                        ...
                                                        <form
                                                            action="{{ route('add-inspection.destroy', $inspection->id) }}"
                                                            method="POST"
                                            ...
                                            @empty
                                                <tr>
                                                    <td colspan="7" class="text-center text-muted">No inspections found.
                                                    </td>
                                                </tr>
                                            @endforelse
                                        </tbody>
