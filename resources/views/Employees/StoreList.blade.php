                                        ...
                                        <tbody>
                                            @forelse ($stores as $store)
                                                <tr>
                                                    ...
                                                    <td>{{ $store->email }}</td>
                                                    <td>{{ $store->phone }}</td>
                                                    <td>{{ \Carbon\Carbon::parse($store->created_at)->timezone('Asia/Kolkata')->format('d M Y, h:i A') }}
                                                    </td>
                                                    <td>
                                                        <span
                                                            class="badge {{ $store->user_status === 'Active' ? 'bg-success' : 'bg-secondary' }}">
                                                            {{ ucfirst($store->user_status) }}
                                                        </span>
                                                    </td>
                                                    <td class="order-btn d-flex">
                                                        @if ($store->user_status == 'Active')
                                                            <form action="{{ route('employee.deactivate', $store->id) }}"
                                                        ...
                                                        @else
                                                            <form action="{{ route('employee.activate', $store->id) }}"
                                                                method="POST" class="me-2">
                                                                @csrf
                                                                <button type="submit"
                                                        ...
                                                        <form action="{{ route('add-store.destroy', $store->id) }}"
                                                            method="POST"
