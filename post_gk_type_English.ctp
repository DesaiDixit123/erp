                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <label class="radio-inline">
                                            <input type="radio" name="langu" value="English" <?= (!empty($entity->langu) && $entity->langu == 'Hindi') ? '' : 'checked' ?>>
                                            English
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="langu" value="Hindi" <?= (!empty($entity->langu) && $entity->langu == 'Hindi') ? 'checked' : '' ?>>
                                            Hindi
                                        </label>
                                    </div>
                                </div>
                                    ...
                                    <div class="lwhitebg">
                                        ...
                                        <div class="boxfrom">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <div class="col-md-12">
                                                    <select id="category_id_post" name="category" class="form-control"
                                                        required>
                                                        <option value="">-- Select Category --</option>
                                                        <?php foreach ($categories as $id => $name) { ?>
                                                            <option value="<?= $id ?>" <?= (!empty($selectedCategory) && $selectedCategory == $id) ? 'selected' : '' ?>>
                                                                <?= $name ?>
                                                            </option>
                                                    ...
                                                    <select id="sub_category_id_post" name="subcategory"
                                                        ...
                                                        <?php if (!empty($subcategories)) {
                                                            foreach ($subcategories as $id => $name) { ?>
                                                                <option value="<?= $id ?>" <?= (!empty($selectedSubcategory) && $selectedSubcategory == $id) ? 'selected' : '' ?>>
                                                                    <?= $name ?>
                                                                </option>
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <div class="col-md-12">
                                                    <select id="section_id_post" name="section" class="form-control"
                                                        required>
                                                        <option value="">-- Select Section --</option>
                                                        <?php if (!empty($sections)) {
                                                            foreach ($sections as $id => $name) { ?>
                                                                <option value="<?= $id ?>" <?= (!empty($entity->section) && $entity->section == $id) ? 'selected' : '' ?>>
                                                                    <?= $name ?>
                                                                </option>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            <?php if (!empty($selectedCategory)) { ?>
                ...
                var editCategory = "<?= $selectedCategory ?>";
                var editSubcategory = "<?= $selectedSubcategory ?>";
                var editSection = "<?= $entity->section ?? '' ?>";
